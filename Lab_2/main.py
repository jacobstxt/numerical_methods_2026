...
# Якщо є точне значення (немає в даних — екстраполяція)
# Для оцінки похибки використаємо значення при 5 вузлах як "еталон"
ref = results[5]
...
plt.tight_layout()
plt.show()
print("\nГрафік збережено: newton_interpolation.png")
