...
# ============================================================
# МЕТОД 1: Проста ітерація (релаксація)
# Перетворення: x = x + tau*F(x) = phi(x)
# tau обираємо як -1/F'(x0) для збіжності 1-го порядку
# ============================================================
...
# ============================================================
# МЕТОД 3: Метод Чебишева
# x_{n+1} = x_n - F/F' - F^2*F''/(2*F'^3)
# Збіжність 3-го порядку
# ============================================================
...
# ============================================================
# МЕТОД 4: Метод хорд (січних)
# x_{n+1} = x_n - F(x_n)*(x_n - x_{n-1}) / (F(x_n) - F(x_{n-1}))
# Порядок збіжності p ≈ 1.618
# ============================================================
...
# ============================================================
# МЕТОД 5: Метод парабол
# F(x) -> інтерполянт 2-го степеня по 3 вузлах.
# Розв'язуємо квадратне рівняння, обираємо корінь, що дає
# НАЙМЕНШУ ЗА МОДУЛЕМ поправку.
# Порядок збіжності ≈ 1.84
# ============================================================
...
# ============================================================
# МЕТОД 6: Метод зворотної інтерполяції
# Інтерполюємо обернену функцію x=x(F) многочленом Лагранжа
# по 3 вузлах, нове наближення = x(F=0)
# ============================================================
